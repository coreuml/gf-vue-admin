...
// arModel is a active record design model for table rules operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of rules.
	Table = "rules"
	// Model is the model object of rules.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table rules.
	Columns = struct {
		PType  string // 类型      
        V0     string // 角色id    
        V1     string // 请求路由  
