...
// arModel is a active record design model for table dictionary_details operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of dictionary_details.
	Table = "dictionary_details"
	// Model is the model object of dictionary_details.
